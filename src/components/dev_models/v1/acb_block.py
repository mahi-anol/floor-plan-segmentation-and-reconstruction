...
class ACBBlock(nn.Module):
    ...
    def _add_to_sqare_kernel(self,sqare_kernel,asym_kernel):
        ...
        sqare_kernel[:,:,shift_h:shift_h+asym_h,shift_w:shift_w+asym_w]+=asym_kernel
    ...
    def get_equivalent_kernel_bias(self):
        ...
        sqare_k,sqare_b=self._fuse_bn_tensor(self.square_conv,self.square_bn)

        self._add_to_sqare_kernel(sqare_k,hor_k)
        self._add_to_sqare_kernel(sqare_k,ver_k)
        return sqare_k,hor_b+ver_b+sqare_b
...
if __name__ == '__main__':
    ...
    for k, p in test_kernel_padding:
        ...
        deployout = acb(x)
        print("Fused Layer Output Shape: ",deployout.shape)
