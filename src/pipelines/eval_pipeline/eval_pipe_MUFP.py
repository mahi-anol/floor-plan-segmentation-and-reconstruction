import torch
from src.pipelines.data_pipeline.data_pipeline import  get_train_test_loader
from src.components.dev_models.MUFP.model  import get_model
...
class configs:
    checkpoint_locations=[
            r"E:/floor-plan-segmentation-and-reconstruction/checkpoints/mufp/Best.pt",
        ]
...
if __name__=="__main__":
    ...
    for i,result in enumerate(results):
        ...
        result_df.to_csv(f"./results/{desired_folder}/eval_metric_mufp.csv")