...
import numpy as np
import torch
from src.pipelines.data_pipeline.data_pipeline_cubicasa_var import get_train_test_loader
from src.components.dev_models.Mufp_var.model import get_model
...
# Dataset
train_dataset_loader,test_dataset_loader=get_train_test_loader(batch_size=1)
# Model
...
scheduler = StepLR(
    optimizer,
    step_size=12,  # decrease every 5 epochs
    gamma=0.1     # multiply LR by 10 or 0.1
)
