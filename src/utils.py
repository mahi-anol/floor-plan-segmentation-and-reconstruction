...
def saving_model_with_state_and_logs(model,optimizer,trial,results,file="model.pt"):
    try:
        os.makedirs(f'checkpoints/{trial}',exist_ok=True)
        path=os.path.join(f'checkpoints/{trial}',file)
        contents={
